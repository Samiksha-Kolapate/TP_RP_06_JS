...
let indoor_para1 = document.getElementById("indoor_para");
...
slct2.onchange = function(){
    indoor_para1.innerHTML = "<option></option>";
    let index = this.value;
       // console.log(indoor_array[index].title);
        //console.log(this.value);
    if(this.value == indoor_array[0].title){
        console.log(indoor_array[0]);
        addtoIndoorPara(indoor_array[0]);
    }
}

function addtoIndoorPara(arr){
    
        let indoorP = document.createElement("option");
        indoorP.text = arr.description;
        indoorP.value = arr.description;
        indoor_para1.appendChild(indoorP);
        console.log(indoor_para1);
    

    /* arr.forEach(function (item){
        let indoor = document.createElement("p");
        indoor.text = item.desc;
        indoor.value = item.desc;
        indoor1.appendChild(indoor);
        console.log(indoor1)
    }); */
}
