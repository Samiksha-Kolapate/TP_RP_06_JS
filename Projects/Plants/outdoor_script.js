...
var outdoor_array = [
    {
        ...
        image : `<img src="img/peace_lilly.webp" width="100px" height="100px">`,
...
function showPlants(outdoor_array){
    for(let i=0;i<outdoor_array.length;i++){
        show_plantsList.innerHTML += `<li> ${outdoor_array[i].image}  ${outdoor_array[i].title}  </li>`;
    }
}

showPlants(outdoor_array);